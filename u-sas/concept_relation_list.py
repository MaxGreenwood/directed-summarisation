...
class concept_relation_list(object):
	...
	def get_concepts_story(self,story_index=0,concept_file_path='amr_proxy_inputs/triples.txt'):
		with open(concept_file_path,'rb') as f:
		...
		# Format of tuple - dict {Label - [[start,end],..]}. For example. - {'Relation' - [0,5],..}; 
